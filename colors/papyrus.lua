...
hl('User3', {bg = 'MistyRose4', fg = 'Red3'})
hl('User4', {bg = 'MistyRose4', fg = 'Orange3'})
hl('User5', {bg = 'MistyRose4', fg = 'Grey'})
hl('User6', {bg = 'MistyRose4', bold = 1, fg = '#CDCABD'})
hl('User7', {bg = 'MistyRose4', fg = '#CDCABD'})
hl('User8', {bg = 'MistyRose4', bold = 1, fg = 'AntiqueWhite2'})
